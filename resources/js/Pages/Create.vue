...
defineComponent({
    components: {Checkbox, PrimaryButton, InputLabel, Link, InputError, TextInput, NeutralLayout}
})
...
function submit() {
    axios.post('/api/profiles', form).then((response) => {
...
<template>
    <NeutralLayout>
        ...
        <h1 class="text-white text-xl text-center mb-5">Create a profil</h1>
